...
export function getPositionDisplayName(position: PositionType): string {
  const names: Record<PositionType, string> = {
    ...
    committee_academic_member: 'Academic Committee Member',
...
export function getPositionShortName(position: PositionType): string {
  const names: Record<PositionType, string> = {
    ...
    treasurer: 'Treasurer',
    social_director: 'Social Dir',
    sports_secretary: 'Sports Sec',
    assistant_sports_secretary: 'Asst Sports Sec',
    pro: 'PRO',
    financial_secretary: 'Fin Sec',
    academic_lead: 'Academic Lead',
    committee_academic_member: 'Academic Member',
    public_relations_officer: 'PRO',
