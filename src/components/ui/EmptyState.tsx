...
function DefaultEmptyIcon() {
  return (
    <svg aria-hidden="true" className="w-12 h-12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1}>
...
export function NoSearchResultsState({ title = 'No results found', description = "Try adjusting your search or filter to find what you're looking for.", ...props }: Partial<EmptyStateProps>) {
  return (
    <EmptyState
      icon={<svg aria-hidden="true" className="w-12 h-12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1}><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg>}
      title={title}
      description={description}
      {...props}
    />
...
export function ErrorState({ title = 'Something went wrong', description = 'We encountered an error loading this content.', action, ...props }: Partial<EmptyStateProps>) {
  return (
    <EmptyState
      icon={<svg aria-hidden="true" className="w-12 h-12 text-coral" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1}><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" /></svg>}
      title={title}
      description={description}
