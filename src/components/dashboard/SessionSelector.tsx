  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-snow border-[3px] border-navy rounded-xl press-3 press-black transition-all text-sm font-bold text-navy"
      >
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-64 bg-snow border-[3px] border-navy rounded-2xl shadow-[4px_4px_0_0_#000] z-50 overflow-hidden">
