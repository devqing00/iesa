...
export default function ApplicationsTab() {
  ...
  /* ── Stats ─────────────────────────────── */
  const pageCount = applications.length;
  const showingTotal = totalApplications;
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-sunny-light border-[3px] border-navy rounded-3xl p-4 shadow-[5px_5px_0_0_#000]">
          <p className="text-label text-navy mb-1">Showing</p>
          <p className="font-display font-black text-2xl text-navy">{pageCount}</p>
        </div>
        <div className="bg-teal-light border-[3px] border-navy rounded-3xl p-4 shadow-[5px_5px_0_0_#000]">
          <p className="text-label text-navy mb-1">Total Matching</p>
          <p className="font-display font-black text-2xl text-navy">{showingTotal}</p>
        </div>
      </div>
      ...
      <Pagination page={appPage} totalPages={Math.ceil(totalApplications / APP_PAGE_SIZE)} onPage={setAppPage} className="mt-4" />
