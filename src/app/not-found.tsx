      ...
      <main className="flex-1 flex items-center justify-center p-8 pt-24">
        <div className="max-w-lg w-full text-center space-y-8">
          ...
          <h1 className="font-display font-black text-8xl sm:text-9xl text-navy leading-none">
            4<span className="inline-block bg-lime border-[3px] border-navy px-3 sm:px-5 py-1 rotate-[-3deg] shadow-[4px_4px_0_0_#000]">0</span>4
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/"
              className="bg-lime border-[3px] border-navy press-3 press-navy px-8 py-4 rounded-2xl font-display font-black text-base text-navy transition-all"
            >
              Back to Home
            </Link>
            <Link
