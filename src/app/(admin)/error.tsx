    ...
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="max-w-md w-full space-y-6 text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          <a href="/admin/dashboard" className="px-6 py-2.5 bg-transparent border-[3px] border-navy rounded-2xl font-display font-bold text-sm text-navy hover:bg-navy hover:text-lime hover:border-lime transition-all">
            Admin Home
          </a>
        </div>
      </div>
