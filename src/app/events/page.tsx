        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl space-y-8">
            <h1 className="font-display font-black text-[2.5rem] sm:text-[4rem] lg:text-[5rem] leading-[0.9] text-navy">
              Connect, Learn,
              <br />
              &amp; <span className="inline-block bg-sunny border-[2px] border-navy px-4 sm:px-6 py-2 rotate-[-1deg] shadow-[3px_3px_0_0_#000]">Grow</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {upcomingEvents.map((event, i) => {
              ...
              return (
                <div key={i} className={`${colors[i % 3]} border-[2px] border-navy rounded-3xl p-6 sm:p-8 press-3 press-black transition-all`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {pastEvents.map((event, i) => (
              <div key={i} className="bg-snow border-[2px] border-navy rounded-3xl p-6 press-4 press-black transition-all">
