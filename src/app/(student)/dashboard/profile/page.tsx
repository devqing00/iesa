...
export default function ProfilePage() {
  ...
  const ROLE_META: Record<string, { label: string; color: string; bg: string; icon: "exec" | "unit" | "class" }> = {
    ...
    social_director: { label: "Social Director", color: "text-lavender", bg: "bg-lavender-light", icon: "exec" },
    sports_secretary: { label: "Sports Secretary", color: "text-teal", bg: "bg-teal-light", icon: "exec" },
    assistant_sports_secretary: { label: "Asst. Sports Secretary", color: "text-teal", bg: "bg-teal-light", icon: "exec" },
    pro: { label: "PRO", color: "text-coral", bg: "bg-coral-light", icon: "exec" },
