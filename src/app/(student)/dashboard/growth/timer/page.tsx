...
export default function StudyTimerPage() {
          ...
          <div className="md:col-span-5 grid grid-cols-1 gap-3">
            ...
            <div className="bg-teal-light border-[3px] border-navy rounded-[1.5rem] p-4 shadow-[4px_4px_0_0_#000] rotate-[0.3deg] hover:rotate-0 transition-transform flex items-center justify-between">
              ...
              <div className="w-10 h-10 rounded-xl bg-teal/20 flex items-center justify-center">
                <svg aria-hidden="true" className="w-5 h-5 text-teal" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 6a.75.75 0 00-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 000-1.5h-3.75V6z" clipRule="evenodd" /></svg>
              </div>
            </div>
            {/* Sessions */}
            ...
            <div className="bg-sunny-light border-[3px] border-navy rounded-[1.5rem] p-4 shadow-[4px_4px_0_0_#000] rotate-[0.5deg] hover:rotate-0 transition-transform flex items-center justify-between">
              ...
              <div className="w-10 h-10 rounded-xl bg-sunny/20 flex items-center justify-center">
                <svg aria-hidden="true" className="w-5 h-5 text-sunny" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0l1.5 7.5L21 9l-7.5 1.5L12 18l-1.5-7.5L3 9l7.5-1.5z"/></svg>
              </div>
            </div>
          </div>
        </div>
 ...
 :"shadow-[3px_3px_0_0_#000]"
              ...
              >
                {isRunning ? (
                  ...
                  <svg aria-hidden="true" className="w-8 h-8 ml-1" viewBox="0 0 24 24" fill="currentColor">
 ...
 isRunning ?"opacity-40 cursor-not-allowed" : showSettings ?"text-navy" :"text-slate hover:text-navy"
            ...
            <p className="mt-6 font-display font-normal text-sm text-navy/50 flex items-center gap-2">
              <svg aria-hidden="true" className="w-3 h-3 text-sunny" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0l1.5 7.5L21 9l-7.5 1.5L12 18l-1.5-7.5L3 9l7.5-1.5z"/></svg>
              {quote}
            </p>
          </div>
        </div>
          ...
          <div className="bg-snow border-[3px] border-navy rounded-[1.5rem] shadow-[3px_3px_0_0_#000] p-6 mb-8">
            <h3 className="font-display font-black text-lg text-navy mb-5 flex items-center gap-2">
              <div className="w-8 h-8 rounded-xl bg-lavender-light flex items-center justify-center">
                <svg aria-hidden="true" className="w-4 h-4 text-lavender" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M11.078 2.25c-.917 0-1.699.663-1.85 1.567L9.05 4.889c-.02.12-.115.26-.297.348a7.493 7.493 0 00-.986.57c-.166.115-.334.126-.45.083L6.3 5.508a1.875 1.875 0 00-2.282.819l-.922 1.597a1.875 1.875 0 00.432 2.385l.84.692c.095.078.17.229.154.43a7.598 7.598 0 000 1.139c.015.2-.059.352-.153.43l-.841.692a1.875 1.875 0 00-.432 2.385l.922 1.597a1.875 1.875 0 002.282.818l1.019-.382c.115-.043.283-.031.45.082.312.214.641.405.985.57.182.088.277.228.297.35l.178 1.071c.151.904.933 1.567 1.85 1.567h1.844c.916 0 1.699-.663 1.85-1.567l.178-1.072c.02-.12.114-.26.297-.349.344-.165.673-.356.985-.57.167-.114.335-.125.45-.082l1.02.382a1.875 1.875 0 002.28-.819l.923-1.597a1.875 1.875 0 00-.432-2.385l-.84-.692c-.095-.078-.17-.229-.154-.43a7.614 7.614 0 000-1.139c-.016-.2.059-.352.153-.43l.84-.692c.708-.582.891-1.59.433-2.385l-.922-1.597a1.875 1.875 0 00-2.282-.818l-1.02.382c-.114.043-.282.031-.449-.083a7.49 7.49 0 00-.985-.57c-.183-.087-.277-.227-.297-.348l-.179-1.072a1.875 1.875 0 00-1.85-1.567h-1.843zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" clipRule="evenodd" />
                </svg>
              </div>
              Timer Settings
          ...
          <div className="md:col-span-8 bg-snow border-[3px] border-navy rounded-[1.5rem] shadow-[4px_4px_0_0_#000] overflow-hidden">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-xl bg-lavender-light flex items-center justify-center">
                  <svg aria-hidden="true" className="w-4 h-4 text-lavender" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 6a.75.75 0 00-1.5 0v6c0 .414.336.75.75.75h4.5a.75.75 0 000-1.5h-3.75V6z" clipRule="evenodd" /></svg>
                </div>
          ...
          <div className="md:col-span-4 bg-navy border-[3px] border-lime rounded-[1.5rem] shadow-[3px_3px_0_0_#C8F31D] p-6 flex flex-col justify-between">
            <div>
              <div className="w-10 h-10 rounded-xl bg-teal/20 flex items-center justify-center mb-4">
                <svg aria-hidden="true" className="w-5 h-5 text-snow" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0l1.5 7.5L21 9l-7.5 1.5L12 18l-1.5-7.5L3 9l7.5-1.5z"/></svg>
              </div>
            ...
            <div className="mt-4 pt-4 border-t border-navy/10">
              <p className="text-[10px] font-bold uppercase tracking-[0.12em] text-snow/30 flex items-center gap-1.5">
                <svg aria-hidden="true" className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M4.5 9.75a6 6 0 0111.573-2.226 3.75 3.75 0 014.133 4.303A4.5 4.5 0 0118 20.25H6.75a5.25 5.25 0 01-.75-10.5z" clipRule="evenodd" /></svg>
