...
export default function CourseProgressPage() {
  ...
  const [courses, setCourses] = useGrowthData<Course[]>('courses', STORAGE_KEY, []);
      ...
      <div className="px-4 md:px-8 py-6 md:py-8 pb-24 md:pb-8 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-8">
          ...
          <div className="md:col-span-5 grid grid-cols-2 gap-3">
            ...
            <div className="bg-coral-light border-[3px] border-navy rounded-2xl p-5 shadow-[3px_3px_0_0_#000] rotate-[-0.3deg] hover:rotate-0 transition-transform flex flex-col justify-between">
          ...
          {courses.length === 0 ? (
            ...
            <div className="space-y-4">
              {courses.map((course) => {
                ...
                return (
                  <div key={course.id} className={`bg-snow border-[3px] border-navy rounded-3xl shadow-[4px_4px_0_0_#000] overflow-hidden ${isComplete ? "opacity-80" : ""}`}>
                    {/* Course header */}
                    <button
