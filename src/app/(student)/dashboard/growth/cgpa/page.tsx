      ...
      <div className="px-4 md:px-8 py-6 md:py-8 pb-24 md:pb-8 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-8 relative">
              ...
              <div className="absolute inset-0 pointer-events-none overflow-hidden z-20">
                {[8, 22, 40, 58, 75, 90].map((left, i) => (
                  <svg
                    ...
                    style={{ left: `${left}%`, top: "15%", animationDelay: `${i * 0.12}s`, color: ["#6ECFC9", "#E05B4B", "#62D5C5", "#D4A6EF", "#E8C94A", "#6ECFC9"][i] }}
            ...
            <div className="md:col-span-7 bg-teal border-[3px] border-navy rounded-[2rem] shadow-[3px_3px_0_0_#000] p-7 md:p-9 rotate-[-0.5deg] hover:rotate-0 transition-transform">
            ...
            <div className="md:col-span-5 bg-navy border-[3px] border-lime rounded-[2rem] shadow-[3px_3px_0_0_#C8F31D] p-7 rotate-[0.5deg] hover:rotate-0 transition-transform flex flex-col justify-between">
              ...
              {hasInteracted ? (
                <>
                  <div className="font-display font-black text-5xl md:text-6xl text-snow mb-1">
                    {result.cgpa}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            <div className="lg:col-span-8 space-y-5">
              ...
              <section className="bg-snow border-[3px] border-navy rounded-[2rem] shadow-[3px_3px_0_0_#000] p-5 md:p-6">
            ...
            <div className="lg:col-span-4 space-y-5">
              ...
              <div className={`${hasInteracted ? classification.bg : "bg-cloud"} border-[3px] border-navy rounded-[1.5rem] shadow-[3px_3px_0_0_#000] p-5`}>
              ...
              {/* History — collapsible */}
              <div className="bg-snow border-[3px] border-navy rounded-[1.5rem] shadow-[3px_3px_0_0_#000] overflow-hidden">
                <button
