      ...
      <div className="px-4 md:px-8 py-6 md:py-8 pb-24 md:pb-8 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-8">
            {/* Title card */}
            <div className="md:col-span-7 bg-lavender border-[3px] border-navy rounded-[2rem] shadow-[3px_3px_0_0_#000] p-7 md:p-9 rotate-[-0.4deg] hover:rotate-0 transition-transform">
            ...
            <div className="md:col-span-5 grid grid-cols-2 gap-3">
              <div className="bg-teal-light border-[3px] border-navy rounded-[1.5rem] shadow-[3px_3px_0_0_#000] p-4 flex flex-col justify-between">
              ...
              <div className="bg-coral-light border-[3px] border-navy rounded-[1.5rem] shadow-[3px_3px_0_0_#000] p-4 flex flex-col justify-between">
              ...
              <div className="bg-sunny-light border-[3px] border-navy rounded-[1.5rem] shadow-[3px_3px_0_0_#000] p-4 flex flex-col justify-between">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-lime text-navy border-[3px] border-navy press-3 press-navy font-display font-bold text-xs uppercase tracking-wider transition-all"
            >
              <svg aria-hidden="true" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 3.75a.75.75 0 01.75.75v6.75h6.75a.75.75 0 010 1.5h-6.75v6.75a.75.75 0 01-1.5 0v-6.75H4.5a.75.75 0 010-1.5h6.75V4.5a.75.75 0 01.75-.75z" clipRule="evenodd"/></svg>
              Add Goal
            </button>
          </div>
          ...
          <div className="space-y-4">
            {filteredGoals.length === 0 ? (
              <div className="bg-snow border-[3px] border-navy rounded-[2rem] shadow-[3px_3px_0_0_#000] p-12 text-center">
                <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-lavender-light border-[3px] border-navy flex items-center justify-center">
                  <svg aria-hidden="true" className="w-7 h-7 text-lavender" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd"/></svg>
                </div>
                ...
                {filter !== "completed" && (
                  <button
                    onClick={() => { setEditingGoal(null); setShowAddModal(true); }}
                    className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-lime text-navy border-[3px] border-navy press-2 press-navy font-display font-bold text-xs uppercase tracking-wider"
                  >
                    <svg aria-hidden="true" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 3.75a.75.75 0 01.75.75v6.75h6.75a.75.75 0 010 1.5h-6.75v6.75a.75.75 0 01-1.5 0v-6.75H4.5a.75.75 0 010-1.5h6.75V4.5a.75.75 0 01.75-.75z" clipRule="evenodd"/></svg>
              ...
              filteredGoals.map((goal, idx) => {
                ...
                return (
                  <div
                    key={goal.id}
                    className={`bg-snow border-[3px] border-navy border-l-[6px] ${accent.border} rounded-[1.5rem] shadow-[4px_4px_0_0_#000] transition-all ${
                  ...
                  >
                    <div className="p-5 md:p-6">
                      <div className="flex items-start gap-3">
                        ...
                        >
                          <svg aria-hidden="true" className={`w-5 h-5 transition-transform ${isExpanded ? "rotate-90" : ""}`} fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z" clipRule="evenodd"/></svg>
                        </button>
                        ...
                        <div className="mt-5 pt-4 border-t-[3px] border-navy/10 space-y-2 ml-8">
                          {goal.milestones.map((milestone) => (
                            <div key={milestone.id} className="flex items-center gap-3 p-3 bg-ghost rounded-xl hover:bg-cloud transition-colors">
                              ...
                              >
                                {milestone.completed ? (
                                  <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z" clipRule="evenodd"/></svg>
                                ) : (
                                  <svg aria-hidden="true" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><circle cx="12" cy="12" r="9"/></svg>
                                )}
                              </button>
