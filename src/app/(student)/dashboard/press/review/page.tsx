  ...
  return (
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {articles.slice((artPage - 1) * ART_PAGE_SIZE, artPage * ART_PAGE_SIZE).map((article) => {
            ...
            return (
              <div key={article._id} className="bg-snow border-[3px] border-navy rounded-3xl p-6 shadow-[4px_4px_0_0_#000]">
                {/* Title row */}
                ...
                {isApproved && (
                  <div className="mt-4 pt-4 border-t-[2px] border-cloud flex flex-wrap gap-2">
                    <button
                      ...
                      disabled={actionLoading === article._id}
                      className="px-4 py-2 bg-lime border-[3px] border-navy rounded-xl text-xs font-display font-bold text-navy press-3 press-navy transition-all disabled:opacity-50"
                    >
                      Publish to Blog
                    </button>
                    <button
