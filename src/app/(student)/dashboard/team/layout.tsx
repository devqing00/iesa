  ...
  return (
    <div className="min-h-screen bg-ghost p-4 sm:p-6 lg:p-8 pb-24 md:pb-8 overflow-x-hidden relative">
      ...
      {[
        ...
        "bottom-20 left-[12%] w-4 h-4 text-navy/8",
      ].map((cls, i) => (
      ...
      <div className="max-w-6xl mx-auto space-y-8 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-4">
          {/* left: title */}
          <div className="col-span-12 md:col-span-7 bg-teal border-[3px] border-navy rounded-[2rem] p-8 shadow-[4px_4px_0_0_#000] rotate-[-0.4deg] hover:rotate-0 transition-transform relative overflow-hidden">
            ...
            <div className="absolute top-4 right-5">
              <svg aria-hidden="true" className="w-6 h-6 text-navy/15" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0l1.5 7.5L21 9l-7.5 1.5L12 18l-1.5-7.5L3 9l7.5-1.5z" />
              </svg>
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-5 grid grid-rows-3 gap-3">
            <div className="bg-coral-light border-[3px] border-navy rounded-[1.5rem] p-4 shadow-[4px_4px_0_0_#000] rotate-[0.5deg] hover:rotate-0 transition-transform flex items-center gap-3">
            ...
            <div className="bg-lavender-light border-[3px] border-navy rounded-[1.5rem] p-4 shadow-[4px_4px_0_0_#000] rotate-[-0.6deg] hover:rotate-0 transition-transform flex items-center gap-3">
            ...
            <div className="bg-sunny-light border-[3px] border-navy rounded-[1.5rem] p-4 shadow-[4px_4px_0_0_#000] rotate-[0.4deg] hover:rotate-0 transition-transform flex items-center gap-3">
