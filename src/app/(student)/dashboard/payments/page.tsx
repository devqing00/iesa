  ...
  const doConfirmedTransferSubmit = async () => {
    ...
    try {
      ...
      if (!uploadRes.ok) {
        ...
        // Roll back orphaned transfer so user is not stuck in pending without receipt
        try {
                ...
                <>
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button onClick={handleTransferSubmit}
                      disabled={transferSubmitting || receiptProcessing || !!refExistsError || !transferForm.bankAccountId || !transferForm.senderName || !transferForm.senderBank || !receiptImage}
                    ...
                    >
                      {transferSubmitting ? "Submitting..." : receiptProcessing ? "Processing..." : "Review & Submit"}
                    </button>
                  </div>
                </>
              )}
