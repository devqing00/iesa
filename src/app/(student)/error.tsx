    ...
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="max-w-md w-full space-y-6 text-center">
        ...
        <div className="flex justify-center gap-4">
          <button onClick={reset} className="bg-transparent border-[3px] border-navy px-5 py-2.5 rounded-xl font-display font-black text-sm text-navy hover:bg-navy hover:text-lime hover:border-lime transition-all">
            Try Again
          </button>
          <a href="/dashboard" className="bg-transparent border-[3px] border-navy px-5 py-2.5 rounded-xl font-display font-black text-sm text-navy hover:bg-navy hover:text-lime hover:border-lime transition-all">
            Back to Dashboard
          </a>
        </div>
      </div>
