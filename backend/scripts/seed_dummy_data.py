...
async def seed_users(db) -> dict[str, str]:
    ...
    users = [
        ...
        {
            "firstName": "Chioma", "lastName": "Agu",
            "email": "chioma@iesa.dev",
            "role": "exco",
            "matricNumber": f"{str(YEAR-5)[2:]}/21IP105",
            "admissionYear": YEAR - 3,
            "currentLevel": "400L",
            "department": "Industrial Engineering",
            "phone": "+2348074567890",
            "bio": "IESA Social Director, 400L. Loves event planning and community engagement.",
            "skills": ["Event Planning", "Social Media", "Marketing", "Team Building"],
            "emailType": "personal",
            "secondaryEmail": "chioma.agu@stu.ui.edu.ng",
            "secondaryEmailType": "institutional",
            "secondaryEmailVerified": True,
            "notificationEmailPreference": "both",
            "notificationChannelPreference": "both",
        ...
        {
            "firstName": "Musa", "lastName": "Adamu",
            "email": "musa@iesa.dev",
            "role": "exco",
            "matricNumber": f"{str(YEAR-5)[2:]}/21IP106",
            "admissionYear": YEAR - 3,
            "currentLevel": "400L",
            "department": "Industrial Engineering",
            "phone": "+2348081234567",
            "bio": "IESA Sports Secretary, 400L. Passionate about athletics and team sports.",
            "skills": ["Sports Management", "Coaching", "Fitness", "Basketball"],
            "emailType": "personal",
            "secondaryEmail": "musa.adamu@stu.ui.edu.ng",
            "secondaryEmailType": "institutional",
            "secondaryEmailVerified": True,
            "notificationEmailPreference": "both",
            "notificationChannelPreference": "both",
        ...
        },
        {
            ...
            "department": "Industrial Engineering",
            "phone": "+2348088764321",
            "bio": "IESA Assistant General Secretary, 300L. Supports general secretary organizational duties.",
            "skills": ["Administrative Support", "Time Management", "Communication", "Excel"],
            "emailType": "personal",
            "secondaryEmail": "yuki.tanaka@stu.ui.edu.ng",
            "secondaryEmailType": "institutional",
            "secondaryEmailVerified": True,
            "notificationEmailPreference": "both",
            "notificationChannelPreference": "both",
        ...
        {
            "firstName": "Ndidi", "lastName": "Udo",
            "email": "ndidi@iesa.dev",
            "role": "exco",
            "matricNumber": f"{str(YEAR-4)[2:]}/22IP107",
            "admissionYear": YEAR - 2,
            "currentLevel": "300L",
            "department": "Industrial Engineering",
            "phone": "+2348079876543",
            "bio": "IESA Assistant Sports Secretary, 300L. Supports sports events and logistics.",
            "skills": ["Sports Administration", "Logistics", "Communication", "Event Coordination"],
            "emailType": "personal",
            "secondaryEmail": "ndidi.udo@stu.ui.edu.ng",
            "secondaryEmailType": "institutional",
            "secondaryEmailVerified": True,
            "notificationEmailPreference": "both",
            "notificationChannelPreference": "both",
        ...
        },
        {
            ...
            "email": "ngozi@iesa.dev",
            "role": "exco",
            "matricNumber": f"{str(YEAR-5)[2:]}/21IP107",
            "admissionYear": YEAR - 3,
            "currentLevel": "400L",
            "department": "Industrial Engineering",
            "phone": "+2348095432101",
            "bio": "IESA Vice President, 400L. Strategic focus on operational excellence and visioning.",
            "skills": ["Strategic Planning", "Operations", "Leadership", "Project Management"],
            "emailType": "personal",
            "secondaryEmail": "ngozi.okoro@stu.ui.edu.ng",
            "secondaryEmailType": "institutional",
            "secondaryEmailVerified": True,
            "notificationEmailPreference": "both",
            "notificationChannelPreference": "both",
        ...
        {
            "firstName": "David", "lastName": "Owusu",
            "email": "david@iesa.dev",
            "role": "exco",
            "matricNumber": f"{str(YEAR-4)[2:]}/22IP106",
            "admissionYear": YEAR - 2,
            "currentLevel": "300L",
            "department": "Industrial Engineering",
            "phone": "+2348073218765",
            "bio": "IESA Financial Secretary, 300L. Manages Department finances and auditing.",
            "skills": ["Finance", "Accounting", "Excel", "QuickBooks", "Auditing"],
            "emailType": "personal",
            "secondaryEmail": "david.owusu@stu.ui.edu.ng",
            "secondaryEmailType": "institutional",
            "secondaryEmailVerified": True,
            "notificationEmailPreference": "both",
            "notificationChannelPreference": "both",
...
async def seed_roles(db, session_id: str, users: dict[str, str]):
    ...
    coll = db["roles"]
    roles_map = [
        # ExCo positions (from new role structure) — 10 positions
        ("tobi@iesa.dev",        "president"),
        ("ngozi@iesa.dev",       "vice_president"),
        ("grace@iesa.dev",       "general_secretary"),
        ("yuki@iesa.dev",        "assistant_general_secretary"),
        ("hakeem@iesa.dev",      "treasurer"),
        ("chioma@iesa.dev",      "social_director"),
        ("musa@iesa.dev",        "sports_secretary"),
        ("ndidi@iesa.dev",       "assistant_sports_secretary"),
        ("fatima@iesa.dev",      "pro"),
        ("david@iesa.dev",       "financial_secretary"),
